class Autenticador:
    ...
    print("Creando autenticador para el usuario 'admin'...")
auth = Autenticador("admin", "segura123")
print("Verificando contraseña correcta:", auth.verificar_contraseña("segura123"))