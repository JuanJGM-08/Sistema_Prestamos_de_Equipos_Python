...
# Se le agregaron los métodos encender y apagar para que el coche pueda cambiar su estado de encendido y apagado.
...
print(mi_coche.apagar())    # Imprime: Toyota Corolla ya estaba apagado
